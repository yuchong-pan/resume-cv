...
\begin{itemize}
  \item Co-Founder, Co-Chairman \& Director of Tech Department, hack.init(), 2017-- .\\
  \emph{Co-Founded the hack.init() hackathon, which aims to be China's premier youth hackathon. Working on management, tech support, corporate relations, recruitment, etc. The prospectus of the hackathon is available at }\url{http://y-pan.co/s/doc/hackinit.pdf}{.}
...
\begin{itemize}
  \item Web Development: Django, HTML/CSS, JavaScript, D3.js, Vue.js, AngularJS.
