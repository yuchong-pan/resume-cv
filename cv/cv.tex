...
\begin{list2}
\item[$\circ$] Are we responsible if we have no choice? (in Chinese). No Nap Seminars. Online. 2020. To appear.
...
\item[$\circ$] $1$st Place, Microsoft College Code Competition, 2017.
