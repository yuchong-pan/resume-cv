...
Algorithms, combinatorics, optimization, theoretical computer science, operations research, network flow theory, traveling salesman problem, submodular optimization, graph algorithms, graph theory, sublinear time algorithms
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
          ...
          \resumeItem{Relevant Coursework}{Algebraic Techniques and Semidefinite Optimization, Sublinear Time Algorithms, Algebraic Methods in Extremal Combinatorics, An Algorithmist's Toolkit, Randomness and Computation, Graph Theory and Additive Combinatorics, Matrix Multiplication and Graph Algorithms, Recent Progress on Traveling Salesman Problem}
      \resumeItemListEnd
    \resumeSubheading
...
\section{Teaching Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{18.085 
        Computational Science and Engineering I}{Fall 2022}
      \resumeItemListEnd
    \resumeSubheading
      {University of British Columbia}{Vancouver, BC}
      {Teaching Assistant}{}
...
\resumeSubHeadingListStart
  \resumeSubheading
  {Massachusetts Institute of Technology}{Cambridge, MA}
  {PRIMES-USA (Department of Mathematics)}{January 2023 -- December 2023}
  \resumeItemListStart
    \researchItem{Remotely mentoring a high school student to perform reseach in algorithms, combinatorics and optimization, including a directed reading period.}
  \resumeItemListEnd
  \resumeSubheading
  {Massachusetts Institute of Technology}{Cambridge, MA}
  {Directed Reading Program (Department of Mathematics)}{January 2023 -- February 2023}
  \resumeItemListStart
    \researchItem{Mentored two undergraduate students to read \emph{Beyond the Worst-Case Analysis of Algorithms} edited by Tim Roughgarden. Advised the students on the presentation in the directed reading program symposium.}
  \resumeItemListEnd
  \resumeSubheading
    {Massachusetts Institute of Technology}{Cambridge, MA}
...
\resumeSubHeadingListStart
  \manuscriptItem{From Bounded Degree to Bounded Arboricity. MIT 6.5240 project. Massachusetts Institute of Technology. Cambridge, MA. 2022.}
