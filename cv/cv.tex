...
\begin{itemize}
  ...
  \emph{Average: $92.9\%$. Took a gap year from May 2016 to August 2017.}
...
\begin{itemize}
  ...
  \item Chief Technology Officer, Shanghai InnoCat Information Technology Co., Ltd., February 2017-- .\\
  \emph{Founded in February 2017, InnoCat is the legal entity of hack.init() Hackathon, China League Hacking and a wide variety of hacker events. InnoCat aims to provide support and connections to hackathon organizers and nurture the hacker culture in China.}

  \item Co-Founder, Executive Board Member \& Director of Tech Department, hack.init() Hackathon, February 2017-- .\\
  \emph{hack.init() is China's premier youth hackathon in cooperation with ShanghaiTech University. I negotiated sponsorships from leading companies including Google, Apple, Sogou, Wolfram, and various Venture Capital and Incubator firms. I also developed and maintained the website of the event as director of Tech Department. Full introduction available at }\url{http://2017.hackinit.io}\emph{.}
...
\begin{itemize}
  \item Differential Calculus (Honours, MATH 120), University of British Columbia\\
  \emph{Completed the course with a final grade of $98\%$.}

  \item Enriched Physics I (Honours, mechanics, PHYS 107), University of British Columbia\\
  \emph{Completed the course with a final grade of $93\%$.}

  \item Models of Computation (CPSC 121), University of British Columbia\\
  \emph{Completed the course with a final grade of $98\%$.}
