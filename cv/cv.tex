...
\item[] Student Assistant, Jan 2019--Apr 2019
...
\item[] Program for Research in Mathematics, Engineering and Science for High School Students (PRIMES-USA, remote), Jan 2023--present.
  \begin{list2}
  \item[$\circ$] Students: Ruiyang (Raymond) Luo (high school)
  \item[$\circ$] Topic: Cyclic Basis Orderings of Matroids
  \end{list2}
\item[] Directed Reading Program, Jan 2023--Feb 2023.
  \begin{list2}
  ...
  \end{list2}
\item[] Extended Summer Program in Undergraduate Research, Jun 2022--Aug 2022.
  \begin{list2}
  ...
  \end{list2}
\item[] Directed Reading Program, Jan 2022--Feb 2022.
  \begin{list2}
...
\begin{list2}
  \item[$\circ$] A counterexample to box-half-integrality of the intersection of crossing submodular flow systems (with M.X.\ Goemans). Unpublished, 2023.
...
\item[$\circ$] From bounded degree to bounded arboricity. Project of MIT 6.5240 (Sublinear Time Algorithms), 2022.
