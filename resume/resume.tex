...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Ph.D., Applied Mathematics}{September 2021 --}
    \resumeSubheading
...
\section{Selected Employment}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Directed Reading Program}{Mentoring two undergraduate students during the IAP period to read a selected book on a mathematical topic related to theoretical computer science or combinatorics. Meeting the students at least three times a week. Advising the students on the presentations in the DRP project symposium.}
    \resumeItemListEnd
    \resumeSubheading
    {University of British Columbia}{Vancouver, BC}
