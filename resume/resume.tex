...
\section{Selected Employment}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Directed Reading Program}{Mentoring two undergraduate students to read \emph{Randomized Algorithms} by Motwani and Raghavan. Advising the students on the presentations in the program symposium.}
    \resumeItemListEnd
    \resumeSubheading
    {University of British Columbia}{Vancouver, BC}
