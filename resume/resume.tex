...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://ypan.me/}{https://ypan.me} & Mobile : +1 (604) 782-7439 \\
\end{tabular*}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Cost and Congestion of Exotic Network Flows}
        {Studied new network flow models with side constraints imposed by new telecommunication technologies (e.g., IP routing, optical networks, etc.). This research assistantship is partially funded by Work Learn International Undergraduate Research Awards.}
    \resumeItemListEnd
    \resumeSubheading
