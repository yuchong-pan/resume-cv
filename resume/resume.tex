    ...
    \resumeSubheading
      ...
      \resumeItemListStart
          ...
          \resumeItem{Coursework}
            {Combinatorial Optimization$^*$, Submodular Optimization$^*$, Tools for Modern Algorithm Analysis$^*$, Probability$^*$, Stochastic Processes$^*$, Number Theory$^*$, Theory of Computing$^*$, Compiler, Programming Languages \\ {\small \begin{flushright}
              \vspace{-.09in}
              $^*$graduate courses
              \vspace{-.2in}
            \end{flushright}}}
