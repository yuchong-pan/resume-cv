    ...
    \resumeSubheading
      ...
      \resumeItemListStart
          ...
          \resumeItem{Coursework}
            {Combinatorial Optimization$^*$, Submodular Optimization$^*$, Tools for Modern Algorithm Analysis$^*$, Probability$^*$, Stochastic Processes$^*$, Number Theory$^*$, Theory of Computing$^*$, Compiler, Programming Languages \\ {\small ($^*$ graduate courses)} \vspace{-.09in}}
      \resumeItemListEnd
