  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{.NET Runtime IL Interpreter}
        {Resurrected the IL (intermediate language) interpreter inside the .NET Runtime. Conducted performance analyses for the various configurations of the IL interpreter. [\href{https://github.com/dotnet/runtime}{GitHub}]}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{.NET Core Uninstall Tool}
          {A guided tool that enables the controlled clean-up of a system such that only the desired versions of .NET Core SDKs and Runtimes remain. [\href{https://github.com/dotnet/cli-lab}{GitHub}]}
...
\section{Selected Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Gradual Octave}
      {Extended the Octave programming language with a gradual type system, incorporating benefits of both static and dynamic type systems. [\href{http://ypan.me/docs/gradual-octave.pdf}{Report}]}
