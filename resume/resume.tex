    ...
    \resumeSubheading
      ...
      \resumeItemListStart
          ...
          \resumeItem{Coursework}
            {Combinatorial Optimization$^*$, Submodular Optimization$^*$, Tools for Modern Algorithm Analysis$^*$, Probability$^*$, Stochastic Processes$^*$, Real Analysis$^*$, Theory of Computing$^*$, Compiler, Programming Languages}
      \resumeItemListEnd
